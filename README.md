...
This README covers the steps to build opscruise slack app

- [CodeSandbox](https://codesandbox.io/): Step 1 -> Step 2A
- On your local machine (Linux/macOS/Windows): Step 1 -> Step 2B
...
## (Step 2B) Your Local Machine Setup
...
### Run the notification.js file - "node notification.js" to send dummy json response for sending Opscruise notification to Slack app.

Originally, the response should come via the original server and so replace the link in post method with the server link.
